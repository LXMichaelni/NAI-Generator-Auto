    ...
    try {
      ...
      if (result != null && result.files.single.bytes != null) {
        ...
        if (fileExtension == 'naiv4vibe') {
          ...
          // TODO: Temporarily disable non-.naiv4vibe formats until
          // information_extracted mapping rules are aligned for those formats.
          throw const FormatException(
              'Only .naiv4vibe is currently supported.');
        }
      ...
      // Handle errors from VibeConfigV4.fromNaiV4VibeJson or file picking
